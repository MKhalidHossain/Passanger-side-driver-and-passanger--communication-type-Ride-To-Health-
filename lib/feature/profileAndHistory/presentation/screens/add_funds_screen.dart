...
class _AddFundsScreenState extends State<AddFundsScreen> {
  ...
  Widget _buildAmountOption(int amount, String type, {bool isPopular = false}) {
    bool isSelected =
          ...
          children: [
            Radio<int>(
              ...
              groupValue: _customAmountController.text.isEmpty
                  ? selectedAmount
                  : null,
              onChanged: (value) => _selectPredefinedAmount(value!),
  ...
  Widget _buildPaymentMethodSection() {
    return Row(
      children: [
        _buildPaymentMethodBadge(selectedPaymentMethod),
        SizedBox(width: 10),
        Text(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ...paymentMethods.map(
                (method) => ListTile(
                  leading: _buildPaymentMethodBadge(method),
